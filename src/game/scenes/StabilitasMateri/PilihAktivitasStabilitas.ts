...
/**
 * The non-linear activity picker between Materi Stabilitas and the two
 * downstream activities (Kuis Stabilitas / the existing SimulatorStabilitas
 * scene) — a hub, reached after finishing the material and returned to
 * after either activity's result screen.
 */
export class PilihAktivitasStabilitas extends Scene {
    private background!: GameObjects.Image;
    private root!: GameObjects.Container;
    private transitionGroups: GameObjects.GameObject[][] = [];

    constructor() {
        super("PilihAktivitasStabilitas");
    }
