...
export class SopepMateri extends Scene {
    ...
    private buildHeader() {
        const navButtons = new HomeBackButtons(this, { x: 32, y: HEADER_Y, size: HEADER_HEIGHT, onHome: () => this.goTo("MainMenu") });
        ...
        this.root.add([navButtons.view, breadcrumb, badgeText, chevron, label, settingsBg, settingsIcon, settingsHit, bgmToggle.view]);
    }
